------------------------------------------------
-- This Source Was Developed By (ABS) @Bahjat100.--
--   This Is The ⦖ ⤾ 𝒁𝑶𝑹𝑶 𝑷𝑳𝑼𝑺 ⤿ ⦕ @SOURCE_ZORO_plus .   --
--                - DevProx -                 --
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1003237899}
DevProx = Config.DevProx
TokenBot = Config.TokenBot
NameBot = (DevABS:get(DevProx..'ABS:NameBot') or 'زورو')
--     Source DevProx     --
...
๛م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
๛[⦖ ⤾ 𝒁𝑶𝑹𝑶 𝑷𝑳𝑼𝑺 ⤿ ⦕](https://t.me/SOURCE_ZORO_plus)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevABS:get(DevProx..'ABS:NameBot') or "زورو")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevABS:get(DevProx..'ABS:NameBot') or "زورو")..' ','')
end
...
{'↫ المطورين ⌁','↫ الاحصائيات ⌁'},
{'↫ المجموعات ⌁','روابط المجموعات','↫ المشتركين ⌁'},
{'↫ تعطيل التواصل ⌁','↫ تفعيل التواصل ⌁'},
{'تنظيف المجموعات','↫ قائمه العام ⌁','تنظيف المشتركين'},
{'↫ تغير المطور الاساسي ⌁'},
...
{'جلب نسخه السورس','تحديث السورس','جلب نسخه المجموعات'},
...
--     Source DevProx     --
if SecondSudo(msg) then
if text == 'جلب نسخه المجموعات' or text == 'جلب نسخه احتياطيه' or text == 'جلب النسخه الاحتياطيه' then
local List = DevABS:smembers(DevProx..'ABS:Groups') 
local BotName = (DevABS:get(DevProx.."ABS:NameBot") or 'زورو')
...
if text and text == (DevABS:get(DevProx..'ABS:NameBot') or 'زورو') then 
NameBot = (DevABS:get(DevProx..'ABS:NameBot') or 'زورو')
...
if tonumber(result.id_) == tonumber(1003237899) then 
Dev_ABS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1003237899) then  
Dev_ABS(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
sudobot = '\n๛عدد المجموعات ↫ '..(DevABS:get(DevProx..'ABS:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n๛عدد المجموعات ↫ '..(DevABS:get(DevProx..'ABS:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n๛عدد المجموعات ↫ '..(DevABS:get(DevProx..'ABS:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
local cont = (tonumber(DevABS:get(DevProx..'ABS:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local msguser = tonumber(DevABS:get(DevProx..'ABS:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local Texting = {"مو صوره ظيم بالنبي ،🤤💞","مقتنع بصورتك !؟ 😹🖤","ملاك وناسيك بمجموعهنه ،🤤💞","وفالله ،🤤💞","كشخه برب ،😉🤍","لزكت بيها دغيرها عاد ،😒😕","صورتك مامرتاحلها ،🙄😶","حلغوم والله ،🥺💘","مو صوره غنبله براسها ٦٠ حظ ،😹🤍"}
...
--     Source DevProx     --
if text == "تنظيف المجموعات" and SecondSudo(msg) and ChCheck(msg) or text == "تنظيف المجموعات" and SecondSudo(msg) and ChCheck(msg) then 
...
Dev_ABS(msg.chat_id_, msg.id_, 1,'๛عدد المجموعات الان ↫ { '..#group..' }'..DevProxgp1..DevProxgp2..'\n๛العدد الحقيقي الان  ↫ ( '..DevProxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
--     Source DevProx     --
if text and text:match("^معلومات المجموعه$") and ChCheck(msg) or text and text:match("^عدد الاعضاء$") and ChCheck(msg) or text and text:match("^عدد المجموعه$") and ChCheck(msg) or text and text:match("^عدد الادمنيه$") and ChCheck(msg) or text and text:match("^عدد المحظورين$") and ChCheck(msg) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevProx.lua', '๛نسخة ملف سورس زورو',dl_cb, nil)
end end
--     Source DevProx     --
if text == 'روابط المجموعات' or text == 'روابط المجموعات' then
if not SecondSudo(msg) then
Dev_ABS(msg.chat_id_, msg.id_, 1, '๛للمطور الاساسي فقط ', 1, 'md')
else
local List = DevABS:smembers(DevProx.."ABS:Groups")
...
Dev_ABS(msg.chat_id_, msg.id_, 1, '๛جاري تحديث سورس زورو', 1, 'md') 
os.execute('rm -rf DevProx.lua') 
os.execute('wget https://raw.githubusercontent.com/jokerrrrrrrrrr7/BAHJAT/main/DevProx.lua') 
dofile('DevProx.lua') 
...
Dev_ABS(msg.chat_id_, msg.id_, 1, '๛Channel ↬ [@SOURCE_ZORO_plus]', 1, 'md')    
end 
--     Source DevProx     --
