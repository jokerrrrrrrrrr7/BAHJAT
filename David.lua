------------------------------------------------
-- This Source Was Developed By (Rio) @UUOUOU_7.--
--   This Is The Source Channel @SOURCE_ZORO_plus .   --
--                - David -                 --
--        -- https://t.me/SOURCE_ZORO_plus --         --
------------------------------------------------ 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1765160742,1516553352,1965297568}
David = Config.David
TokenBot = Config.TokenBot
NameBot = (DevRio:get(David..'Rio:NameBot') or 'زورو')
--     Source David     --
...
local UserName = (dp.username_ or "SOURCE_ZORO_plus")
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="᥀ᴢᴏʀᴏ ᴘʟụѕ .",url="t.me/SOURCE_ZORO_plus"}}} 
...
᥀︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/SOURCE_ZORO_plus)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevRio:get(David..'Rio:NameBot') or "زورو")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(David..'Rio:NameBot') or "زورو")..' ','')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_ZORO_plus')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ᥀','↫ اغنيه ᥀'},
{'↫ ميمز ᥀','↫ ريمكس ᥀'},
{'↫ صوره ᥀','↫ متحركه ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس زورو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس زورو فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "SOURCE_ZORO_plus")}},
{{text="᥀ السورس .",url="https://t.me/SOURCE_ZORO_plus"},{text="᥀ لتنصيب بوت .",url="https://t.me/UUOUOU_7"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "SOURCE_ZORO_plus")..')', 1, 'md') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or SOURCE_ZORO_plus}}}
...
{{text = '᥀ David Team .', url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@SOURCE_ZORO_plus]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@SOURCE_ZORO_plus]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source David     --
--        Contact         --
...
local BotName = (DevRio:get(David.."Rio:NameBot") or 'زورو')
...
if text and text == (DevRio:get(David..'Rio:NameBot') or 'زورو') then 
NameBot = (DevRio:get(David..'Rio:NameBot') or 'زورو')
...
⤿ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐈𝐍 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ⤾](https://t.me/SOURCE_ZORO_plus) ᥀
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/SOURCE_ZORO_plus"}},
{{text = '᥀ Developer',url="t.me/UUOUOU_7"},{text = '᥀ Developer',url="https://t.me/V_P_E"}},{{text= '᥀ Tws Black .',url="JOK_ER_7bot"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/https://t.me/BLACK_TEAM_4/1088&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/SOURCE_ZORO_plus' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "SOURCE_ZORO_plus")..")"
else 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس زورو', 1, 'md') 
...
DevRio:set(David..'Rio:NameBot',(DevRio:get(David..'Name:Bot') or 'زورو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Text = [[
᥀︙[قناة السورس](https://t.me/SOURCE_ZORO_plus)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/SOURCE_ZORO_plus"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ZORO_plus&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
